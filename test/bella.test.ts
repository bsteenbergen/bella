...
describe("the interpreter", () => {
  ...
  it("interprets identifier expressions ok", () => {
    const program = new bella.Program(
      new bella.Block([
        new bella.VariableDeclaration(
          new bella.Identifier("x"),
          new bella.Numeral(100)
        ),
  ...
  it("interprets array literals and subscripts ok", () => {
    const program = new bella.Program(
      new bella.Block([
        new bella.PrintStatement(
          new bella.ArrayLiteral([
            new bella.Numeral(3),
  ...
  it("interprets built in functions ok", () => {
    const program = new bella.Program(
      new bella.Block([
        new bella.PrintStatement(
          new bella.Call(new bella.Identifier("sqrt"), [new bella.Numeral(2)])
        ),
      ])
    );
    bella.interpret(program);
  ...
  it("interprets binary and unary expressions ok", () => {
    const program = new bella.Program(
      new bella.Block([
        ...
        new bella.Assignment(
          new bella.Identifier("x"),
          new bella.UnaryExp("-", new bella.Numeral(20))
        ),
        new bella.PrintStatement(
          new bella.BinaryExp(
            "*",
  ...
  it("interprets conditional expressions ok", () => {
    const program = new bella.Program(
      new bella.Block([
        new bella.PrintStatement(
          new bella.ConditionalExpression(
            new bella.BinaryExp(
              ">",
              new bella.Numeral(3),
              new bella.Numeral(2)
  ...
  it("interprets while statements ok", () => {
    const program = new bella.Program(
      new bella.Block([
        new bella.VariableDeclaration(
          new bella.Identifier("y"),
          new bella.Numeral(0)
        ),
        new bella.While(
          new bella.BinaryExp(
            ">",
            new bella.Numeral(10),
            new bella.Identifier("y")
          ),
          new bella.Block([
            new bella.Assignment(
  ...
  it("interprets function statements ok", () => {
    const program = new bella.Program(
      new bella.Block([
        ...
        new bella.FunctionDeclaration(
          new bella.Identifier("plusFour"),
          [new bella.Identifier("x")],
          new bella.BinaryExp(
            "+",
            new bella.Identifier("x"),
        ...
        new bella.PrintStatement(
          new bella.Call(new bella.Identifier("plusFour"), [
            new bella.Identifier("i"),
          ])
        ),
      ])
